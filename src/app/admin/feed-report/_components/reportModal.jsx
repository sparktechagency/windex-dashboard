...
export default function ReportModal({
  ...
  // Reported profile and feed details from user object (mapped from refference in ReportReviewTable)
      ...
      <div className="m-10">
        ...
        <div className="my-5">
          ...
          <RowData
            ...
            value={reportedProfile.description}
          />
          <RowData name="Audience" value={reportedProfile.audience} />
